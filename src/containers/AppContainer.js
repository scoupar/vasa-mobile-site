...
const AppContainer = () => {
    return(
        ...
        <div className = "video">
        <iframe className = "player"width="400" height="200" src="https://www.youtube.com/embed/8KIcsZw2XNg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        ...
        <div className = "social-container">
            <SocialIcon url = "https://open.spotify.com/artist/0qb2PA9d6mQD2RwY5MdfW5?si=IKmkI6FFT9KZZg5BLsVn1Q" target ="blank" network = "spotify" bgColor = "GoldenRod" className ="icon" style={{height:50, width:50}}/>
            <SocialIcon url = "https://music.apple.com/us/artist/vasa/27755625" target ="blank" network = "itunes" bgColor = "GoldenRod" className ="icon" style={{height:50, width:50}}/>
